 ...
 *
 * Steps:
 *   1. Create one Organisation row named "Scryloft" with lead_employee_id="jinn".
 ...
 *      Scryloft Organisation, default task_mode="untracked" (today's behavior).
 */

export const SCRYLOFT_DEFAULT_NAME = "Scryloft";
export const SCRYLOFT_DEFAULT_LEAD = "jinn";
export const SCRYLOFT_DEFAULT_WIP_CAP = 3;
...
export function runOrganisationsMigration(opts: { jinnHome?: string } = {}): MigrationResult {
  ...
  const org = createOrganisation({
    name: SCRYLOFT_DEFAULT_NAME,
    leadEmployeeId: SCRYLOFT_DEFAULT_LEAD,
    wipCap: SCRYLOFT_DEFAULT_WIP_CAP,
  });
